...
func NewZap(level string, files ...string) *zap {
	var l zapcore.Level
	...
	config.OutputPaths = append(config.OutputPaths, files...)
	config.ErrorOutputPaths = append(config.ErrorOutputPaths, files...)
